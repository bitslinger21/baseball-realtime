import { BoxscoreApi, Configuration, GamesApi, PlayersApi, StandingsApi } from '@bitslinger21/baseball-realtime-client';
...
export const playersApi: PlayersApi = new PlayersApi(configuration);