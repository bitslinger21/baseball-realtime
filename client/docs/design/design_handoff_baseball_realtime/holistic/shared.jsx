...
window.TEAMS = {
  HOU: { abbr: 'HOU', name: 'Houston Astros',      primary: '#002D62', secondary: '#EB6E1F' },
  CHC: { abbr: 'CHC', name: 'Chicago Cubs',        primary: '#0E3386', secondary: '#CC3433' },
  PIT: { abbr: 'PIT', name: 'Pittsburgh Pirates',  primary: '#27251F', secondary: '#FDB827' },
  TOR: { abbr: 'TOR', name: 'Toronto Blue Jays',   primary: '#134A8E', secondary: '#1D2D5C' },
  DET: { abbr: 'DET', name: 'Detroit Tigers',      primary: '#0C2340', secondary: '#FA4616' },
  BAL: { abbr: 'BAL', name: 'Baltimore Orioles',   primary: '#DF4601', secondary: '#27251F' },
  CLE: { abbr: 'CLE', name: 'Cleveland Guardians', primary: '#00385D', secondary: '#E50022' },
  PHI: { abbr: 'PHI', name: 'Philadelphia Phillies', primary: '#E81828', secondary: '#284898' },
  TBR: { abbr: 'TBR', name: 'Tampa Bay Rays',      primary: '#092C5C', secondary: '#8FBCE6' },
  NYY: { abbr: 'NYY', name: 'New York Yankees',    primary: '#0C2340', secondary: '#C4CED4' },
  LAD: { abbr: 'LAD', name: 'Los Angeles Dodgers', primary: '#005A9C', secondary: '#EF3E42' },
  ATL: { abbr: 'ATL', name: 'Atlanta Braves',      primary: '#13274F', secondary: '#CE1141' },
};
...
window.TeamMark = function TeamMark({ team, size = 56 }) {
  // Larger circular mark with a band of secondary color — for headers/heroes
  return (
    <div style={{
