...
// ---------- Headshot placeholder (grey box w/ team color band) ----------

function Headshot({ team, initials, size = 64 }) {
  return (
    <div style={{
      ...
      <div style={{
        height: 6, background: team.primary,
      }} />
      <div style={{
      ...
      <div style={{
        ...
        <div style={{ padding: 18, display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          <div style={{ display: 'flex', gap: 12, alignItems: 'flex-start' }}>
            <Headshot team={TEAMS.CHC} initials="AB" size={68} />
...
function PitchByPitchV2() {
  ...
  const PAs = [
    ...
    { id: 'allen',   inning: 'TOP 9', team: TEAMS.HOU, batter: 'Nick Allen',      summary: 'Home run to LCF · 412 ft',   icon: 'HR', color: T.accent },
    ...
    { id: 'smith',   inning: 'BOT 8', team: TEAMS.CHC, batter: 'Cam Smith',       summary: 'Triple to RF · 1-1',         icon: '3B', color: T.positive },
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <Segmented items={['All', 'Outcomes', 'Runs', 'K', 'HR', 'BB']} active={0} size="sm" />
        </div>
      </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                ...
                <span style={{
                  ...
                  background: pa.team.primary, color: '#fff',
                  display: 'grid', placeItems: 'center',
                  fontFamily: T.sans, fontSize: 9, fontWeight: 700, letterSpacing: '0.04em',
                }}>{pa.team.abbr}</span>
              </div>
              {pa.live ? (
  ...
  return (
    <Card padless>
      ...
      <div style={{ padding: 20, display: 'grid', gridTemplateColumns: 'auto 1fr auto', gap: 20, alignItems: 'center' }}>
        <Headshot team={TEAMS.HOU} initials="NP" size={80} />
...
window.GameScreenV2 = function GameScreenV2() {
  return (
    <Page>
      <AppHeader right={
        <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}>
          <button style={{ ...btn, display: 'inline-flex', alignItems: 'center', gap: 8 }}>
            <span style={{ fontFamily: T.sans, fontWeight: 600 }}>Lineup</span>
