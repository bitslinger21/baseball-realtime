...
export class InitSchema1761819225633 implements MigrationInterface {
    name = 'InitSchema1761819225633'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`games\` (\`id\` varchar(36) NOT NULL, \`providerGameId\` varchar(255) NOT NULL, \`gameDate\` date NOT NULL, \`homeAbbr\` varchar(5) NOT NULL, \`awayAbbr\` varchar(5) NOT NULL, \`status\` varchar(20) NOT NULL, \`startTimeUtc\` timestamp NULL, \`snapshot\` json NULL, INDEX \`IDX_ff8871185b78ee757de1f1fb12\` (\`gameDate\`), INDEX \`IDX_0e1c7c502f997a45e8ad5e3677\` (\`homeAbbr\`), INDEX \`IDX_2de7762f933945ec9ed90a86a4\` (\`awayAbbr\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
